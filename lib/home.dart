  ...
  final List<Map<String, String>> clubs = const [
    {
      ...
      "description": "Technical innovation hub for electrical and electronics",
    },
    {
      "name": "Robotics Club",
      "description": "Automation, AI, and robotics projects",
    },
    {
    ...
    {
      "name": "Literary Club",
      "description": "Debates, creative writing, and public speaking",
    },
    {
      "name": "Music Club",
      "description": "Instrumental performances and vocal training",
    },
    {
      "name": "Dance Club",
      "description": "Various dance forms and choreography workshops",
    },
    {
    ...
    },
    {
      ...
      "description": "Startup incubation and business mentoring",
    },
    {
      "name": "Sports Club",
      "description": "Organizes athletic activities and tournaments",
    },
    {"name": "Quiz Club", "description": "Hosts inter-department competitions"},
    {
      "name": "Theatre Club",
      "description": "Drama productions and stage performances",
    },
  ];
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            trailing: IconButton(
                              icon: Icon(
                                favoriteClubs.contains(club['name'])
                                    ? Icons.star
                                    : Icons.star_border,
                                color:
                                    favoriteClubs.contains(club['name'])
                              ...
                              onPressed: () {
                                setState(() {
                                  if (favoriteClubs.contains(club['name'])) {
                                    favoriteClubs.remove(club['name']);
                                  } else {
                                    favoriteClubs.add(club['name']!);
                                  }
                                });
                              },
                            ),
